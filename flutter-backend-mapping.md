...
> 依据：`design/nkas-mobile-interactive.html`、`module/webui/api/app.py` 及各路由实现。
>
...
接入前应以 `design/nkas-mobile-interactive.html` 和本文件为准，先删除旧的页面/菜单模型：
