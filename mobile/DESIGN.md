...
固定尺寸：图标按钮视觉 40x40（触控至少 44x44），主按钮最小高度 38，Sheet 操作至少 44，设置行至少 56，实例行至少 68，任务行至少 55，底部导航 296x58，导航单项至少 46x46。
...
原型是居中的白色半透明胶囊：宽 296px、高 58px、底部 14px + SafeArea、五项等宽。选中为 `blueSoft` 背景、蓝色图标和底部 4px 小圆点。只切换总览、实例、日志、部署、设置，不放启停或更新；部署页对应后端 deploy 配置。
